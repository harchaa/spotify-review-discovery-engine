...
def test_ranked_bar_chart_sorts_ascending_for_horizontal_display():
    ...
    fig = app.ranked_bar_chart(records, "theme", "weighted_count", app.THEME_LABELS, "#2a78d6", False, "count")
    bar = fig.data[0]
